        ...
        <div class="listArtist container">
            ...
            <div class="row d-flex align-items-center justify-content-center pt-lg-5">
                <div class="col-sm-12 col-xl-4 col-md-4">
                    <img class="w-100 h-100 p-4" src="https://www.trinityproduction.com/storage/uploads/2022/01/29/afgan-1_uid_61f507807ed04.png" alt="">
                </div>
                <div class="col-sm-12 col-xl-4 col-md-4">
                    <img class="w-100 h-100 p-4" src="https://www.trinityproduction.com/storage/uploads/2022/02/07/Maudy-Ayunda_uid_6201ad9bed8c0.jpg" alt="">
                </div>
                <div class="col-sm-12 col-xl-4 col-md-4">
                    <img class="w-100 h-100 p-4" src="https://www.trinityproduction.com/storage/uploads/2022/02/10/KA6A8131_uid_62045e38984c5.jpg" alt="">
                </div>
            </div>
            <div class="row d-flex align-items-end justify-content-end">
                <div class="featured_album_title_bar d-flex flex-row align-items-center justify-content-start">
                    <div class="featured_album_link ml-auto"><a href="/artist">Our Artist</a></div>
                </div>
            </div>
        </div>
        <!-- end::list artist -->
