<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="/star-admin/index.html">
            <img src="/star-admin/images/logo.svg" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="/star-admin/index.html">
            <img src="/star-admin/images/logo-mini.svg" alt="logo" />
          </a>
        </div>
      </div>
