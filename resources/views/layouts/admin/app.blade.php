...
<head>
  ...
  <link rel="stylesheet" href="{{ url('star-admin/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}">
  <link rel="stylesheet" href="{{ url('star-admin/js/select.dataTables.min.css') }}">
...
<script>
  ...
  <script src="{{ url('star-admin/vendors/chart.js/Chart.min.js') }}"></script>
  <script src="{{ url('star-admin/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
  <script src="{{ url('star-admin/vendors/progressbar.js/progressbar.min.js') }}"></script>
  ...
  <script src="{{ url('star-admin/js/dashboard.js') }}"></script>
  <script src="{{ url('star-admin/js/Chart.roundedBarCharts.js') }}"></script>
